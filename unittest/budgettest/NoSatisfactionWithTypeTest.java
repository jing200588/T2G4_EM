...
public class NoSatisfactionWithTypeTest {

	private Vector<Integer> compulsoryList;
	private String input;

	public NoSatisfactionWithTypeTest() throws Exception{
	...
	public void noBudgetNoCompulsoryItem() throws Exception {
		...
		ControllerBudget cb = new ControllerBudget(input, 0, 1, 0, currentEvent); //Budget = $0

		cb.differentiateCompulsory(compulsoryList, 0); // compulsory list is empty

		cb.findOptimalShopList(1, 0);
	...
	public void lowestBudgetNoCompulsoryItem() throws Exception {
		...
		ControllerBudget cb = new ControllerBudget(input, 4998, 1, 0, currentEvent); //Budget = $49.98; cheapest item = $49.99 
	...
	public void BudgetEnoughForCompulsoryItem() throws Exception {
		...
		ControllerBudget cb = new ControllerBudget(input, 115618, 1, 0, currentEvent); //Budget = $1156.18; Compulsory item cost = $1156.18 
	...
	public void BudgetEnoughForSomeItemWithoutCompulsoryItem() throws Exception {
		...
		ControllerBudget cb = new ControllerBudget(input, 50000, 1, 0, currentEvent); //Budget = $500.00
		
		cb.differentiateCompulsory(compulsoryList, 0);

		cb.findOptimalShopList(1, 0);
		
		assertEquals(18, cb.getSolutionSize());
	}
	...
	public void BudgetEnoughForSomeItemWithCompulsoryItem() throws Exception {
		...
		ControllerBudget cb = new ControllerBudget(input, 200000, 1, 0, currentEvent); //Budget = $2000.00
		...
		assertEquals(3, cb.getSolutionSize());//inclusive of empty set 
		assertTrue(0.0 == cb.getSolutionCost(0));//empty set
		assertTrue(64.7 == cb.getSolutionCost(1));
		assertTrue(49.99 == cb.getSolutionCost(2));
	}
