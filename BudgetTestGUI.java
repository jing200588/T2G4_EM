...
public class BudgetTestGUI extends ApplicationWindow {
		...
		container.setLayout(null);
		{
			...
			btnCreateEvent.addSelectionListener(new SelectionAdapter() {
				public void widgetSelected(SelectionEvent e) {
					...
					BudgetViewOverall CreatePage = new BudgetViewOverall(c2, SWT.NONE);
...
/*			
	...
	*/		
	...
	public static void main(String args[]) {
		try {
			BudgetTestGUI window = new BudgetTestGUI();
